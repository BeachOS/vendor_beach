...
if [[ -z $2 ]] ; then
  TARGET_FILES=out/target/product/$DEVICE/obj/PACKAGING/target_files_intermediates/beach_$DEVICE-target_files-$BUILD.zip
...
EXTRA_SIGNING_ARGS+=(-k prebuilts/beach/microg/certs/microg=$KEY_DIR/../common/microg)
EXTRA_SIGNING_ARGS+=(-k external/beach/chromium/certs/chromium=$KEY_DIR/../common/chromium)
